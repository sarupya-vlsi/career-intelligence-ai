...
### 3. Run Pipeline (Generates Processed Data & Model)
...
If you have a LaTeX distribution (like MiKTeX or TeX Live) installed:

```powershell
powershell -ExecutionPolicy Bypass -File .\compile_xelatex.ps1
```

This compiles [`reports/RESEARCH_PAPER.tex`](reports/RESEARCH_PAPER.tex) into [`reports/RESEARCH_PAPER.pdf`](reports/RESEARCH_PAPER.pdf).

---

## License

This project is created for educational and internship evaluation purposes under the **MIT License**.
